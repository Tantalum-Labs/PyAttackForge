...
Source: https://support.attackforge.com/attackforge-enterprise/modules/self-service-restful-api/getvulnerabilities
...
```
GET /api/ss/vulnerabilities?startDate=2021-06-03T00:00:00.000Z HTTP/1.1
```
...
**q\_vulnerability (or q) (*****string*****) (*****optional*****)**
...
**q\_writeup (*****string*****) (*****optional*****)**

Provides options to query a custom selection of writeups.

Please visit the following link for more details on how to use this filter: [https://support.attackforge.com/attackforge-enterprise/modules/self-service-restful-api/advanced-query-filterarrow-up-right](https://support.attackforge.com/attackforge-enterprise/modules/self-service-restful-api/advanced-query-filter)

Example 1 - Find vulnerabilities with 'TODO' in the recommendation only:
...
[PreviousGetVulnerabilityByIdchevron-left](/attackforge-enterprise/modules/self-service-restful-api/getvulnerability)[NextGetVulnerabilitiesByAssetNamechevron-right](/attackforge-enterprise/modules/self-service-restful-api/getvulnerabilitiesbyassetname)
