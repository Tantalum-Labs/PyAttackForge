...
Source: https://support.attackforge.com/attackforge-enterprise/modules/self-service-restful-api/getprojectvulnerabilities
...
[PreviousGetProjectTestcasesByIdchevron-left](/attackforge-enterprise/modules/self-service-restful-api/getprojecttestcases)[NextGetProjectWorkspacechevron-right](/attackforge-enterprise/modules/self-service-restful-api/getprojectworkspace)
