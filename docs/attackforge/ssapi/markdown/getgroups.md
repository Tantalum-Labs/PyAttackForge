...
Source: https://support.attackforge.com/attackforge-enterprise/modules/self-service-restful-api/getgroups
...
#### [hashtag](#allgroups-boolean) **allGroups (*****boolean*****)**
...
[PreviousGetGroupchevron-left](/attackforge-enterprise/modules/self-service-restful-api/getgroup)[NextGetMostCommonVulnerabilitieschevron-right](/attackforge-enterprise/modules/self-service-restful-api/getmostcommonvulnerabilities)
