...
Source: https://support.attackforge.com/attackforge-enterprise/modules/self-service-restful-api/getassetsbygroup
...
```
GET /api/ss/assets/group/5e6880f33e6d520a26fef4b0 HTTP/1.1
```
...
[PreviousGetAssetschevron-left](/attackforge-enterprise/modules/self-service-restful-api/getassets)[NextGetAssetInLibrarychevron-right](/attackforge-enterprise/modules/self-service-restful-api/getassetinlibrary)
